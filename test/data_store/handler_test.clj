...
(deftest handler-test
  ...
  (testing "SET with expiration"
    (is (= [{"Name" {:val "John" :exp 100000}} "+OK\r\n"] (handler {"Name" {:val "John"}} ["*3" "$3" "SET" "$4" "Name" "$7" "John" "$2" "EX" "$3" "100"] 0)))
    (is (= [{"Name" {:val "John" :exp 100}} "+OK\r\n"] (handler {"Name" {:val "John"}} ["*3" "$3" "SET" "$4" "Name" "$7" "John" "$2" "PEX" "$3" "100"] 0))))
  (testing "GET"
  ...
  (testing "GET with expiration"
    ...
    (is (= [{"Name" {:val "John" :exp 10}} "+John\r\n"] (handler {"Name" {:val "John" :exp 10}} ["*2" "$3" "GET" "$4" "Name"] 10)))))
